  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Streamlining your dining experience with effortless table reservations and seamless management for restaurant employees."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Streamlining your dining experience with effortless table reservations and seamless management for restaurant employees.`}
            </Text>
            <Box
